...
namespace Microsoft.Spark.CSharp.Streaming
{
    ...
    public class DStream<T>
    {
        ...
        internal DStream<U> Map<U>(Func<T, U> f, SerializedMode mode, bool preservesPartitioning = false)
        {
            return MapPartitionsWithIndex(new MapHelper<T, U>(f).Execute, mode, preservesPartitioning);
        }
        ...
        internal DStream<U> MapPartitionsWithIndex<U>(Func<int, IEnumerable<T>, IEnumerable<U>> f, SerializedMode mode, bool preservesPartitioningParam = false)
        {
            return Transform<U>(new MapPartitionsWithIndexHelper<T, U>(f, preservesPartitioningParam, mode).Execute);
        }
    ...
    internal class MapPartitionsWithIndexHelper<I, O>
    {
        ...
        private readonly SerializedMode serializedMode;
        internal MapPartitionsWithIndexHelper(Func<int, IEnumerable<I>, IEnumerable<O>> f, bool preservesPartitioningParam = false, SerializedMode serializedMode = SerializedMode.Byte)
        {
            func = f;
        ...
        internal RDD<O> Execute(RDD<I> rdd)
        {
            ...
            // return rdd.MapPartitionsWithIndex(func, serializedMode, preservesPartitioningParam);
        }
    }
